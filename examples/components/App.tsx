  ...
  renderHeader(docPage = true) {
    ...
    return (
      <>
        ...
        <div
          className={`${theme.ns}Layout-headerBar ${docPage ? 'DocLayout-headerBar' : ''
  ...
  return (
    <Router history={browserHistory}>
      <Route component={App}>
        <Redirect
          from={`${ContextPath}/`}
          to={`${ContextPath}/${locate}/docs1/index1`}
        />
        ...
        <Redirect
          ...
          to={`${ContextPath}/${locate}/components/page111`}
        />
        {/* test */}
        <Route path={`${ContextPath}/test/`} component={GONG}>
        </Route>

        {/* expamles */}
        <Redirect
          from={`${ContextPath}/examples`}
          to={`${ContextPath}/examples/index111`}
        />
        <Redirect
